...
import { Radio, LayoutDashboard, Settings, LogOut } from "lucide-react";
      ...
      <main className="flex-1 px-8 py-10 overflow-auto">
        <div className="max-w-5xl">
          ...
          {!isLoading && services.length === 0 && !error && (
            <div className="flex flex-col items-center justify-center py-24 text-center border border-dashed border-white/[0.08] rounded-xl">
